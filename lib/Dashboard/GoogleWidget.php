...
namespace OCA\Google\Dashboard;

use OCP\Dashboard\IWidget;
use OCP\IL10N;
use OCA\Google\AppInfo\Application;

class GoogleWidget implements IWidget {
	...
	public function getTitle(): string {
		return $this->l10n->t('Google notifications');
	}
	...
	public function load(): void {
		\OC_Util::addScript(Application::APP_ID, 'integration_google-dashboard');
