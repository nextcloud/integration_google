OC.L10N.register(
    ...
    "_%s file was imported from Google Drive._::_%s files were imported from Google Drive._" : [" %s Foto wurde von Google importiert.","%s Fotos wurden von Google importiert."],
    ...
    "Google integration allows you to automatically import your Google calendars, contacts, photos and files into Nextcloud." : "Die Google-Einbindung hilft Dir automatisch Deine Google-Kalender, Kontakte, Fotos und Dateien in Nextcloud hinzuzufügen.",
    ...
    "Import in {name} address book" : "Ins {name} Adressbuch importieren",
    "Calendars" : "Kalender",
    "Import calendar" : "Kalender importieren",
    "Photos" : "Fotos",
    "Ignore shared albums" : "Freigegebene Alben ignorieren",
    "Warning: Google does not provide location data in imported photos." : "Achtung: Google stellt bei importierten Fotos keine Standortdaten bereit.",
    "Import directory" : "Import-Verzeichnis",
    "Import Google photos" : "Google Fotos importieren",
    "Your Google photo collection size is estimated to be bigger than your remaining space left ({formSpace})" : "Die Größe Deiner Google-Fotosammlung ist schätzungsweise größer als Dein verbleibender Platz ({formSpace})",
    ...
    "_{nbFiles} file in Google Drive ({formSize} + {formSharedSize} shared with you)_::_{nbFiles} files in Google Drive ({formSize} + {formSharedSize} shared with you)_" : ["{nbFiles} Datei in Google Drive ({formSize} + {formSharedSize} mit Dir geteilt)","{nbFiles} Dateien in Google Drive ({formSize} + {formSharedSize} mit Dir geteilt)"],
