OC.L10N.register(
    ...
    "You can close this page. You will be notified when it finishes." : "Du kannst diese Seite schließen. Du wirst darüber informiert, sobald der Prozess beendet ist.",
    ...
    "No Google OAuth app configured. Ask your Nextcloud administrator to configure Google connected accounts admin section." : "Google OAuth-App nicht konfiguriert. Bitte deine Nextcloud-Administration, den Administraionsbereich für verbundene Google-Konten zu konfigurieren.",
    ...
    "You can close this page. You will be notified when the import finishes." : "Du kannst diese Seite schließen. du wirst benachrichtigt, sobald der Import abgeschlossen ist.",
    "Queue another session" : "Eine weitere Sitzung in die Warteschlange stellen",
    "Waiting for you to finish your selection in the Google Photos window…" : "Wir warten darauf, dass du deine Auswahl im Google Fotos-Fenster abschließst …",
    ...
    "Up to 2,000 photos can be imported per session. Hold Shift and click to select many photos at once in the Google Photos picker." : "Pro Sitzung können bis zu 2.000 Fotos importiert werden. Halte die Umschalttaste gedrückt und klicke, um mehrere Fotos gleichzeitig in der Google Fotos-Picker auszuwählen.",
    ...
    "Import will start automatically once you confirm your selection." : "Der Importvorgang startet automatisch, sobald du deine Auswahl bestätigt hast.",
    "Drive" : "Drive",
