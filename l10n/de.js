OC.L10N.register(
    ...
    "Photo import background process will begin soon." : "Der Import der Fotos wird in kürze im Hintergrund stattfinden.",
    "Last photo import job at {date}" : "Letzter Fotoimport-Auftrag am {date}",
    "You can close this page. You will notified when it finishes." : "Du kannst diese Seite nun schließen. Du wirst darüber informiert, wenn es fertig ist.",
    "Google Drive background import process will begin soon." : "Der Google Drive Import wird in kürze im Hintergrund stattfinden.",
