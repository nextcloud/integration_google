OC.L10N.register(
    ...
    "Google integration allows you to automatically migrate your Google calendars, contacts, and files into Nextcloud." : "A integración de Google permítelle migrar automaticamente os seus calendarios, contactos, e ficheiros de Google a Nextcloud.",
    ...
    "Google may require site verification for OAuth to work with your site, which can be done in Google's search console" : "Google pode requirir a verificación do sitio para que OAuth funcione co seu sitio, pode facelo na consola de buscas de Google",
    "Google Search console" : "Consola de buscas de Google",
    "Make sure you set one \"Authorized redirect URI\" to" : "Asegúrese de definir un «URI de redirección autorizado» como",
    "Put the \"Client ID\" and \"Client secret\" below." : "Poña  o «ID de cliente» e o «Segredo do cliente» a seguir.",
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", and \"People API\"." : "Finalmente, vai a «APIs & Services» → «Library» e engada as seguintes API: «Google Drive API», «Google Calendar API» e «People API».",
    ...
    "Choose where to write imported \"shared with me\" files" : "Escoller onde gravar os ficheiros «compartidos comigo» importados",
    ...
    "Contacts" : "Contactos",
    "Include other contacts" : "Incluír outros contactos",
    "{amount} Google + {otherAmount} other contacts" : "{amount} Google + {otherAmount} outros contactos",
    ...
    "Import all events including Birthdays" : "Importar todos os eventos incluíndo os aniversarios",
    ...
    "Shared files import directory" : "Directorio de importación de ficheiros compartidos",
