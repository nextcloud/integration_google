OC.L10N.register(
    ...
    "Import in \"{name}\" address book" : "Importar na axenda de enderezos \"{name}\".",
    "Calendars" : "Calendarios",
    "Import calendar" : "Importar o calendario",
    "Photos" : "Fotos",
    "Ignore shared albums" : "Ignorar os albums compartidos",
    "Warning: Google does not provide location data in imported photos." : "Aviso: Google non proporciona datos de localización nas fotos importadas.",
    ...
    "Your Google Drive ({formSize} + {formSharedSize} shared with you)" : "O teu Google Drive ({formSize} + {formSharedSize} compartido contigo)",
