OC.L10N.register(
    ...
    "Google" : "Google",
    "_%s photo was imported from Google._::_%s photos were imported from Google._" : ["Importouse %s foto de Google.","Importáronse %s fotos de Google."],
    "_%s file was imported from Google Drive._::_%s files were imported from Google Drive._" : ["Importouse %s ficheiro de Google Drive.","Importáronse %s ficheiros de Google Drive."],
    "Google Drive import" : "Importación de Google Drive",
    "Google Photos import" : "Importación de Google Fotos",
    ...
    "Google integration allows you to automatically import your Google calendars and contacts into Nextcloud." : "A integración de Google permítelle importar automaticamente os seus calendarios e contactos de Google a Nextcloud.",
    ...
    "No Google OAuth app configured. Ask your Nextcloud administrator to configure Google connected accounts admin section." : "Non se configurou ningunha aplicación de Google OAuth. Pídalle ao administrador de Nextcloud que configure a sección de administración de contas conectadas a Google.",
    ...
    "Photo import process will begin soon" : "O proceso de importación de fotos comezará en breve",
    "Google Drive import process will begin soon" : "O proceso de importación de Google Drive comezará en breve",
