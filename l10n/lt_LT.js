OC.L10N.register(
    ...
    "You can close this page. You will notified when it finishes." : "Galite užverti šį puslapį. Jums bus pranešta, kai ji pasibaigs.",
    ...
    "_{amount} photo imported ({progress}%)_::_{amount} photos imported ({progress}%)_" : ["Importuota {amount} nuotrauka ({progress}%)","Importuotos {amount} nuotraukos ({progress}%)","Importuota {amount} nuotraukų ({progress}%)","Importuota {amount} nuotrauka ({progress}%)"],
