OC.L10N.register(
    ...
    "Google Drive import" : "„Google“ disko importavimas",
    "Google Photos import" : "„Google“ nuotraukų importavimas",
    ...
    "If you want to allow your Nextcloud users to authenticate to Google, create an OAuth application in your Google settings." : "Jei norite leisti savo Nextcloud naudotojams nustatinėti savo tapatybę „Google“ sistemoje, tuomet „Google“ nustatymuose sukurkite „OAuth“ programėlę.",
    ...
    "Client ID of your Google application" : "Jūsų „Google“ programėlės kliento ID",
    "Client secret" : "Kliento paslaptis",
    "Client secret of your Google application" : "Jūsų „Google“ programėlės kliento paslaptis",
    ...
    "Connect to Google" : "Prisijungti prie „Google“",
    ...
    "_~{nbPhotos} Google photo (~{formSize})_::_~{nbPhotos} Google photos (~{formSize})_" : ["~{nbPhotos} „Google“ nuotrauka (~{formSize})","~{nbPhotos} „Google“ nuotraukos (~{formSize})","~{nbPhotos} „Google“ nuotraukų (~{formSize})","~{nbPhotos} „Google“ nuotrauka (~{formSize})"],
