OC.L10N.register(
    ...
    "Google integration allows you to automatically import your Google calendars, contacts, photos and files into Nextcloud." : "Η ενσωμάτωση Google σάς επιτρέπει να εισάγετε αυτόματα τα ημερολόγια, τις επαφές, τις φωτογραφίες και τα αρχεία σας Google στο Nextcloud.",
    ...
    "Make sure you set one \"Authorized redirect URI\" to" : "Βεβαιωθείτε ότι έχετε ορίσει ένα \"URI εξουσιοδοτημένης ανακατεύθυνσης\" σε",
    "Put the \"Client ID\" and \"Client secret\" below." : "Βάλτε τα παρακάτω \"Αναγνωριστικό πελάτη\" και \"Μυστικό πελάτη\".",
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Photos Library API\"." : "Τέλος, μεταβείτε στο \"APIs & Services\" => \"Βιβλιοθήκη\" και προσθέστε τα ακόλουθα API: \"Google Drive API\", \"Google Calendar API\", \"People API\" και \"Photos Library API\".",
    ...
    "Import in {name} address book" : "Εισαγωγή στο {όνομα} βιβλίο διευθύνσεων ",
    "Calendars" : "Ημερολόγια",
    "Import calendar" : "Εισαγωγή ημερολογίου",
    "Photos" : "Φωτογραφίες",
    "Ignore shared albums" : "Παράβλεψη κοινόχρηστων άλμπουμ",
    "Warning, Google does not provide location data in imported photos." : "Προειδοποίηση, η Google δεν παρέχει δεδομένα τοποθεσίας σε εισαγόμενες φωτογραφίες.",
    "Import directory" : "Εισαγωγή καταλόγου",
    "Import Google photos" : "Εισαγωγή φωτογραφιών Google",
    "Your Google photo collection size is estimated to be bigger than your remaining space left ({formSpace})" : "Το μέγεθος της συλλογής φωτογραφιών σας Google εκτιμάται ότι είναι μεγαλύτερο από τον εναπομένοντα χώρο σας ({formSpace})",
    ...
    "Failed to get number of Google photos" : "Αποτυχία λήψης αριθμού φωτογραφιών Google",
    ...
    "Failed to start importing Google photos" : "Αποτυχία έναρξης εισαγωγής φωτογραφιών Google",
