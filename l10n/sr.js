OC.L10N.register(
    ...
    "Google" : "Google",
    "_%s photo was imported from Google._::_%s photos were imported from Google._" : ["%s слика је увезена са Google.","%s слике су увезене са Google.","%s слика је увезено са Google."],
    "_%s file was imported from Google Drive._::_%s files were imported from Google Drive._" : ["%s фајл је увезен са Google Drive.","%s фајла су увезена са Google Drive.","%s фајлова је увезено са Google Drive."],
