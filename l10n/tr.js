OC.L10N.register(
    "integration_google",
    {
    "No logged in user" : "Oturum açmış bir kullanıcı yok",
    "Missing refresh token in Google response." : "Google yanıtında yenileme kodu eksik.",
    ...
    "Google" : "Google",
    "_%n photo was imported from Google._::_%n photos were imported from Google._" : ["%n fotoğraf Google üzerinden içe aktarıldı.","%n fotoğraf Google üzerinden içe aktarıldı."],
    "_%n file was imported from Google Drive._::_%n files were imported from Google Drive._" : ["%n dosya Google Drive üzerinden içe aktarıldı.","%n dosya Google Drive üzerinden içe aktarıldı."],
    ...
    "Google integration allows you to automatically migrate your Google calendars, contacts, and files into Nextcloud." : "Google bütünleştirmesi, Google takvimlerinizi, kişilerinizi ve dosyalarınızı otomatik olarak Nextcloud üzerine aktarmanızı sağlar.",
    ...
    "Google may require site verification for OAuth to work with your site, which can be done in Google's search console" : "Sitenizde OAuth çalışması için Google site doğrulaması isteyebilir. Bu işlemi Google Search panosundan yapabilirsiniz",
    "Google Search console" : "Google Search panosu",
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Google Photos Picker API\"." : "Son olarak \"API ve hizmetler\" => \"Kitaplık\" bölümüne gidin ve şu API uygulamalarını ekleyin: \"Google Drive API\", \"Google Calendar API\", \"People API\" ve \"Google Photos Picker API\".",
    ...
    "Use a pop-up to authenticate" : "Kimlik doğrulaması için açılan pencere kullanılsın",
    "Last Google Drive import job at {date}" : "Son Google Drive içe aktarımı {date}",
    "Google Drive background import process will begin soon." : "Birazdan arka planda Google Drive içe aktarma işlemine başlanacak.",
    "You can close this page. You will be notified when it finishes." : "Bu sayfayı kapatabilirsiniz. İşlem tamamlandığında bilgilendirileceksiniz.",
    ...
    "_{total} event successfully imported in {name} ({nbAdded} created, {nbUpdated} updated)_::_{total} events successfully imported in {name} ({nbAdded} created, {nbUpdated} updated)_" : ["{total} etkinlik {name} içine aktarıldı ({nbAdded} oluşturuldu, {nbUpdated} güncellendi)","{total} etkinlik {name} içine aktarıldı ({nbAdded} oluşturuldu, {nbUpdated} güncellendi)"],
    "Failed to import Google calendar" : "Google takvimi içe aktarılamadı",
    "Google Photos Picker" : "Google Fotoğraflar seçici",
    "Failed to create Google Photos picker session" : "Google Fotoğraflar seçme oturumu oluşturulamadı",
    "Session queued, it will start automatically after the current import finishes" : "Oturum sıraya alındı. Geçerli içe aktarma tamamlandıktan sonra otomatik olarak başlayacak",
    "Starting importing photos in {targetPath} directory" : "{targetPath} klasöründeki fotoğrafların içe aktarılmasına başlanıyor",
    "Failed to start importing Google Photos" : "Google Fotoğraflar içe aktarma işlemine başlanamadı",
    ...
    "Failed to start importing Google Drive" : "Google Drive dosyalarının içe aktarılması işlemine başlanamadı",
    "Choose where to write imported files" : "İçe aktarılan dosyaların kaydedileceği konumu seçin",
    "Choose where to write imported \"shared with me\" files" : "İçe aktarılan \"benimle paylaşılan\" dosyaların yazılacağı konumu seçin",
    "Google data migration" : "Google veri aktarımı",
    "No Google OAuth app configured. Ask your Nextcloud administrator to configure Google connected accounts admin section." : "Herhangi bir Google OAuth uygulaması yapılandırılmamış. Nextcloud yöneticinizden, yönetim bölümünden Google bağlı hesaplarını yapılandırmasını isteyin.",
    "Authentication" : "Kimlik doğrulama",
    "Connected as {user}" : "{user} olarak bağlantı kuruldu",
    "Disconnect from Google" : "Google bağlantısını kes",
    "Contacts" : "Kişiler",
    "Include other contacts" : "Diğer kişiler katılsın",
    "{amount} Google + {otherAmount} other contacts" : "{amount} Google + {otherAmount} diğer kişi",
    "{amount} Google contacts" : "{amount} Google kişileri",
    "Import Google Contacts in Nextcloud" : "Google Kişilerini Nextcloud içine aktar",
    ...
    "Photos" : "Fotoğraflar",
    "Import queued, starting soon…" : "İçe aktarma sıraya alındı. Yakında başlayacak…",
    "You can close this page. You will be notified when the import finishes." : "Bu sayfayı kapatabilirsiniz. İçe aktarma tamamlandığında bilgilendirileceksiniz.",
    "Queue another session" : "Başka bir oturumu sıraya al",
    "Waiting for you to finish your selection in the Google Photos window…" : "Google Fotoğraflar penceresinde seçiminizi bitirmenizi bekliyoruz…",
    "Open Google Photos picker" : "Google Fotoğraflar seçiciyi aç",
    "Cancel photo picking" : "Fotoğraf seçmekten vazgeç",
    "Cancel importing all photos" : "Tüm fotoğrafları içe aktarmayı iptal et",
    "Import directory" : "İçe klasör aktar",
    "Up to 2,000 photos can be imported per session. Hold Shift and click to select many photos at once in the Google Photos picker." : "Her oturumda 2.000 taneye kadar fotoğraf içe aktarılabilir. Google Fotoğraflar seçicisinde aynı anda çok sayıda fotoğraf seçmek için Shift tuşunu basılı tutarak tıklayın.",
    "Google does not provide location data in imported photos, and imported videos may be lower quality than the original files." : "Google, içe aktarılan fotoğrafların konum verilerini sağlamaz ve içe aktarılan videolar özgün dosyalardan daha düşük kalitede olabilir.",
    "Import will start automatically once you confirm your selection." : "Seçiminizi onayladıktan sonra içe aktarma otomatik olarak başlayacak.",
    "Drive" : "Drive",
    "Ignore shared files" : "Paylaşılmış dosyalar yok sayılsın",
    "Google documents import format" : "Google belgeleri içe aktarma biçimi",
    "Shared files import directory" : "Paylaşılan dosyaların içe aktarılacağı klasör",
    ...
    "_{count} session queued_::_{count} sessions queued_" : ["{count} oturum sıraya alındı","{count} oturum sıraya alındı"],
