OC.L10N.register(
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", and \"People API\"." : "Son olarak \"API ve hizmetler\" => \"Kitaplık\" bölümüne gidin ve şu API uygulamalarını ekleyin: \"Google Drive API\", \"Google Calendar API\" ve \"People API\".",
