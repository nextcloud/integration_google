OC.L10N.register(
    ...
    "Google" : "Google",
    "_%s photo was imported from Google._::_%s photos were imported from Google._" : ["%s fotoğraf Google üzerinden içe aktarıldı.","%s fotoğraf Google üzerinden içe aktarıldı."],
    "_%s file was imported from Google Drive._::_%s files were imported from Google Drive._" : ["%s dosya Google Drive üzerinden içe aktarıldı.","%s dosya Google Drive üzerinden içe aktarıldı."],
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Photos Library API\"." : "Son olarak \"API`ler ve Hizmetler\" => \"Kitaplık\" bölümüne gidin ve şu API uygulamalarını ekleyin: \"Google Drive API\", \"Google Calendar API\", \"People API\" ve \"Photos Library API\".",
    ...
    "Your Google Drive is bigger than your remaining space left ({formSpace})" : "Google Drive boyutunuz kalan boş alanınızdan daha büyük gibi görünüyor ({formSpace})",
    "Cancel Google Drive import" : "Google Drive içe aktarmayı iptal et",
    "Photo import background process will begin soon." : "Birazdan arka planda fotoğrafların içe aktarılmasına başlanacak.",
    ...
    "Google Drive background import process will begin soon." : "Birazdan arka planda Google Drive içe aktarılmasına başlanacak.",
