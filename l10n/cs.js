OC.L10N.register(
    ...
    "_~{nbPhotos} Google photo (~{formSize})_::_~{nbPhotos} Google photos (~{formSize})_" : ["~{nbPhotos} Google fotografie (~{formSize})","~{nbPhotos} Google fotografie (~{formSize})","~{nbPhotos} Google fotografie (~{formSize})","~{nbPhotos} Google fotografie (~{formSize})"],
