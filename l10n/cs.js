OC.L10N.register(
    ...
    "Google notifications" : "Upozorňování z Google",
    ...
    "Integration of Google services" : "Napojení na služby Google",
    "Google integration helps you to automatically add your Google calendars in Nextcloud." : "Napojení na Google vám pomůže automaticky přidat vaše Google kalendáře do Nextcloud.",
    ...
    "Client ID or your Google application" : "Identif. klienta nebo vaše Google aplikace",
    "Client secret" : "Klientské tajemství",
    "Client secret or your Google application" : "Klientské tajemství nebo vaše Google aplikace",
    ...
    "When you create a personal access token yourself, give it at least \"read:user\", \"user:email\" and \"notifications\" permissions." : "Když si osobní přístupový token vytváříte sami, udělte mu přinejmenším oprávnění pro „čtení:uživatrel“ an „upozornění“.",
    ...
    "Photos" : "Fotky",
    "{amount} Google photos" : "{amount} Google fotek",
    ...
    "Google calendars were successfully added." : "Google kalendáře úspěšně přidány.",
    "Failed to add calendars" : "Nepodařilo se přidat kalendáře",
    ...
    "{number} contacts successfully imported in {name}" : "{number} kontaktů úspěšně naimportováno v {name}",
    "{number} events successfully imported in {name}" : "{number} událostí úspěšně naimportováno v {name}",
    "Failed to import Google calendar" : "Nepodařilo se importovat Google kalendář",
    "{number} photos successfully imported in {targetPath}" : "{number} fotek úspěšně naimportováno do {targetPath}",
    "Failed to import Google photos" : "Nepodařilo se importovat fotky Google",
    "Click here to configure the access to your Google account." : "Klikněte sem pro nastavení přístupu ke svému Google účtu.",
    "Incorrect access token." : "Nesprávný přístupový token.",
    "Nothing to show" : "Není co zobrazit",
    "Mark as read" : "Označit jako přečtené",
    "Unsubscribe" : "Zrušit přihlášení k odběru",
    "Failed to get Google notifications." : "Nepodařilo se získat upozornění z Google.",
    "Failed to edit Google notification." : "Nepodařilo se upravit Google upozornění.",
    "You were mentioned in a pull request" : "Byli jste zmíněni v požadavku na začlenění kódu",
    "You were mentioned in an issue" : "Byli jste zmíněni v hlášení chyby",
    "Comment" : "Komentář",
    "Your review was requested" : "Bylo vyžádáno zrevidování od vás",
    "Pull request state changed" : "Stav požadavku na začlenění kódu se změnil",
    "Issue state changed" : "Stav hlášení chyby se změnil",
    "You are assigned" : "Jste přiřazeni"
},
