OC.L10N.register(
    ...
    "Connect to Google" : "Poveži z računom Google",
    ...
    "_~{nbPhotos} Google photo (~{formSize})_::_~{nbPhotos} Google photos (~{formSize})_" : ["~{nbPhotos} slika Google Photos (~{formSize})","~{nbPhotos} sliki Google Photos (~{formSize})","~{nbPhotos} slike Google Photos (~{formSize})","~{nbPhotos} slik Google Photos (~{formSize})"],
