OC.L10N.register(
    ...
    "Google integration allows you to automatically migrate your Google calendars, contacts, photos and files into Nextcloud." : "La integración con Google te permite migrar automáticamente todos tus calendarios, contactos, fotos y archivos de Google a Nextcloud.",
    "If you want to allow your Nextcloud users to authenticate to Google, create an OAuth application in your Google settings." : "Si quiere permitir que sus usuarios de Nextcloud se autentiquen en Google, cree una aplicación OAuth en la configuración de Google.",
    ...
    "Set the \"Application type\" to \"Web application\" and give a name to the application." : "Configure el «Tipo de aplicación » como «Aplicación web» y dele un nombre a la aplicación.",
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Photos Library API\"." : "Finalmente, vaya a \"APIs y Servicios\" => \"Biblioteca\" y añada las siguientes APIs: \"API de Google Drive\",  \"API de Google Calendar\", \"API de Personas\" y \"API de la biblioteca de fotos\".",
