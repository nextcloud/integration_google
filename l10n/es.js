OC.L10N.register(
    ...
    "_{number} contact successfully imported in {name}_::_{number} contacts successfully imported in {name}_" : ["{number} contacto importado con éxito en {name}","{number} contactos importados con éxito en {name}","{number} contactos importados con éxito en {name}"],
