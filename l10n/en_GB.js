OC.L10N.register(
    ...
    "Google integration allows you to automatically migrate your Google calendars, contacts, and files into Nextcloud." : "Google integration allows you to automatically migrate your Google calendars, contacts, and files into Nextcloud.",
    ...
    "Google may require site verification for OAuth to work with your site, which can be done in Google's search console" : "Google may require site verification for OAuth to work with your site, which can be done in Google's search console",
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Google Photos Picker API\"." : "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Google Photos Picker API\".",
    ...
    "Failed to create Google Photos picker session" : "Failed to create Google Photos picker session",
    "Session queued, it will start automatically after the current import finishes" : "Session queued, it will start automatically after the current import finishes",
    ...
    "Contacts" : "Contacts",
    "Include other contacts" : "Include other contacts",
    "{amount} Google + {otherAmount} other contacts" : "{amount} Google + {otherAmount} other contacts",
    ...
    "Photos" : "Photos",
    "Import queued, starting soon…" : "Import queued, starting soon…",
    "You can close this page. You will be notified when the import finishes." : "You can close this page. You will be notified when the import finishes.",
    "Queue another session" : "Queue another session",
    "Waiting for you to finish your selection in the Google Photos window…" : "Waiting for you to finish your selection in the Google Photos window…",
    "Open Google Photos picker" : "Open Google Photos picker",
    "Cancel photo picking" : "Cancel photo picking",
    "Cancel importing all photos" : "Cancel importing all photos",
    "Import directory" : "Import directory",
    "Up to 2,000 photos can be imported per session. Hold Shift and click to select many photos at once in the Google Photos picker." : "Up to 2,000 photos can be imported per session. Hold Shift and click to select many photos at once in the Google Photos picker.",
    "Google does not provide location data in imported photos, and imported videos may be lower quality than the original files." : "Google does not provide location data in imported photos, and imported videos may be lower quality than the original files.",
    "Import will start automatically once you confirm your selection." : "Import will start automatically once you confirm your selection.",
    "Drive" : "Drive",
    ...
    "_{count} session queued_::_{count} sessions queued_" : ["{count} session queued","{count} sessions queued"],
