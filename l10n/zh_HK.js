OC.L10N.register(
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", and \"People API\"." : "最後，請轉到「API 與服務」=>「媒體庫」，然後新增以下 API：「Google Drive API」、「Google Calendar API」與「People API」。",
