OC.L10N.register(
    ...
    "Google may require site verification for OAuth to work with your site, which can be done in Google's search console" : "Google kann eine Seitenüberprüfung anfordern, damit OAuth mit Ihrer Website funktioniert. Dies kann in der Google-Suchkonsole erledigt werden",
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Drive API\", \"Google Calendar API\", \"People API\" and \"Google Photos Picker API\"." : "Abschließend gehen Sie zu \"API & Dienste\" =>\"Bibliothek\" und fügen Sie die folgenden APIs hinzu: \"Google Calendar API\", \"People API\" und \"Google Photos API\".",
    ...
    "Google Photos Picker" : "Google Fotos-Picker",
    "Failed to create Google Photos picker session" : "Google Fotos-Picker Sitzung konnte nicht erstellt werden",
    "Session queued, it will start automatically after the current import finishes" : "Die Sitzung wurde in die Warteschlange gestellt und startet automatisch nach Abschluss des aktuellen Imports",
    "Starting importing photos in {targetPath} directory" : "Beginn des Imports von Fotos in das Verzeichnis {targetPath}",
    "Failed to start importing Google Photos" : "Der Import von Google Fotos ist fehlgeschlagen",
    "Choose where to write imported photos" : "Auswählen, wohin die Fotos importiert werden sollen",
    ...
    "Choose where to write imported \"shared with me\" files" : "Auswählen, wohin importierte \"mit mir geteilte\" Dateien geschrieben werden sollen",
    ...
    "Contacts" : "Kontakte",
    "Include other contacts" : "Andere Kontakte einbeziehen",
    "{amount} Google + {otherAmount} other contacts" : "{amount} Google und {otherAmount} andere Kontakte",
    ...
    "Photos" : "Fotos",
    "Import queued, starting soon…" : "Import in Warteschlange, startet in Kürze …",
    "You can close this page. You will be notified when the import finishes." : "Sie können diese Seite schließen. Sie werden benachrichtigt, sobald der Import abgeschlossen ist.",
    "Queue another session" : "Eine weitere Sitzung in die Warteschlange stellen",
    "Waiting for you to finish your selection in the Google Photos window…" : "Wir warten darauf, dass Sie Ihre Auswahl im Google Fotos-Fenster abschließen …",
    "Open Google Photos picker" : "Google Fotos-Picker öffnen",
    "Cancel photo picking" : "Fotoauswahl abbrechen",
    "Cancel importing all photos" : "Import aller Fotos abbrechen",
    "Import directory" : "Import-Verzeichnis",
    "Up to 2,000 photos can be imported per session. Hold Shift and click to select many photos at once in the Google Photos picker." : "Pro Sitzung können bis zu 2.000 Fotos importiert werden. Halten Sie die Umschalttaste gedrückt und klicken Sie, um mehrere Fotos gleichzeitig in der Google Fotos-Picker auszuwählen.",
    "Google does not provide location data in imported photos, and imported videos may be lower quality than the original files." : "Google stellt in importierten Fotos keine Standortdaten bereit, und importierte Videos können eine geringere Qualität als die Originaldateien aufweisen.",
    "Import will start automatically once you confirm your selection." : "Der Importvorgang startet automatisch, sobald Sie Ihre Auswahl bestätigt haben.",
    "Drive" : "Drive",
    "Ignore shared files" : "Freigegebene Dateien ignorieren",
    "Google documents import format" : "Google Dokumente Importformat",
    "Shared files import directory" : "Importverzeichnis für geteilte Dateien",
    ...
    "_{count} session queued_::_{count} sessions queued_" : ["{count} Sitzung in der Warteschlange","{count} Sitzungen in der Warteschlange"],
