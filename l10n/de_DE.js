OC.L10N.register(
    ...
    "Photo import background process will begin soon." : "Die Importierung der Bilder in in kürze im Hintergrund beginnen.",
    "Last photo import job at {date}" : "Letzter Fotoimport-Auftrag am {date}",
    "You can close this page. You will notified when it finishes." : "Sie können diese Seite nun schließen. Sie werden informiert, sobald der Prozess beendet ist.",
    "Google Drive background import process will begin soon." : "Die Google Drive Importierung wird in kürze im Hintergrund beginnen.",
