OC.L10N.register(
    ...
    "Google integration allows you to automatically import your Google calendars, contacts, photos and files into Nextcloud." : "Die Google-Einbindung hilft Ihnen automatisch Ihre Google-Kalender, Kontakte, Fotos und Dateien in Nextcloud zu importieren.",
    ...
    "Make sure you set one \"Authorized redirect URI\" to" : "Stellen Sie sicher, dass Sie eine \"Autorisierte Weiterleitungs-URI\" gesetzt ist auf",
    "Put the \"Client ID\" and \"Client secret\" below." : "Geben Sie unten die \"Client ID\" und das \"Client-Geheimnis\" ein.",
    ...
    "Photo import background process will begin soon." : "Hntergrund-Prozess des Fotoimports wird bald beginnen.",
    ...
    "You can close this page. You will notified when it finishes." : "Sie können diese Seite schließen. Sie werden informiert, sobald der Prozess beendet ist.",
    ...
    "Starting importing files in {targetPath} directory" : "Importierung der Dateien im Verzeichnis {targetPath} starten",
    ...
    "_{amount} photo imported ({progress}%)_::_{amount} photos imported ({progress}%)_" : ["{amount} Foto importiert ({progress}%)","{amount} Fotos importiert ({progress}%)"],
    "_{nbFiles} file in Google Drive ({formSize} + {formSharedSize} shared with you)_::_{nbFiles} files in Google Drive ({formSize} + {formSharedSize} shared with you)_" : ["{nbFiles} Datei in Google Drive ({formSize} + {formSharedSize} mit Dir geteilt)","{nbFiles} Dateien in Google Drive ({formSize} + {formSharedSize} mit Ihnen geteilt)"],
