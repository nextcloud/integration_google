OC.L10N.register(
    ...
    "Finally, go to \"APIs & Services\" => \"Library\" and add the following APIs: \"Google Calendar API\", \"People API\" and \"Photos Library API\"." : "Abschließend gehen Sie zu \"API & Dienste\" =>\"Bibliothek\" und fügen Sie die folgenden APIs hinzu: \"Google Calendar API\", \"People API\" and \"Photos Library API\".",
    ...
    "You Google photo collection size is estimated to be bigger than your remaining space left ({formSpace})" : "Die Größe Ihrer Google-Fotosammlung ist schätzungsweise größer als der verbleibende verbleibende Speicherplatz ({formSpace})",
